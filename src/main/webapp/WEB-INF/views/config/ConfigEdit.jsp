...
<body>
	...
	<div class="container pbg2">
		<div class="content">
			<div class="cPanel">
				<form action="${contextPath }/config/configurations_edit" method="post" rel="submit" target="_self">
						...
						<tbody>
							<tr>
								...
								<td>
									...
									<input type="text" value="${edit_config.ckey }"
									name="ckey" id="ckey" class="textInputN" isempty="no" maxlength="64"/></td>
							</tr>
							<tr>
								<th align="right">配置：</th>
								<td><input type="text" value="${edit_config.cvalue }"
									name="cvalue" id="cvalue" class="textInputN" isempty="no" /></td>
							</tr>
							<tr>
								<th align="right">类别：</th>
								<td>
									<sys:type name="ctype" blankShow="true" selectValue="${edit_config.ctype}" style="width: 159px;" id="ctype"/>
								</td>
							</tr>
							<tr>
								<th align="right">状态：</th>
								<td>
									<drop:down selectCode="STATE" blankShow="true" name="enable" selectValue="${edit_config.enable}" style="width: 159px;"/>
								</td>
							</tr>
							<tr>
								<th align="right">描述：</th>
								<td><input type="text" value="${edit_config.desc }"
