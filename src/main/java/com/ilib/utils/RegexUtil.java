...
public class RegexUtil {
	 ...
	 * 
	 * */
	public static boolean checkNumberV0(String num) {
	...
	public static boolean checkDoubleNumAll(String postCode, int limitNum) {
		int newLimitNum = 2;
		if (limitNum > 2) {
			newLimitNum = limitNum;
		}
		String regex = "-?([0-9]\\d*(\\.[0-9]{1," + newLimitNum + "})?)$";
		return startCheck(regex, postCode);
	}
	...
	public static boolean isMobile(String mobile) {
		...
		return startCheck(regex, mobile);
	}
	...
	public static boolean isPhone(String phone) {
		String regex = "^0[0-9]{2,3}[-|－]{0,1}[0-9]{7,8}([-|－][0-9]{1,4})?$";
	 ...
	 * @return
	 */
	public static boolean isPhoneV2(String phone) {
		String regex = "^0[0-9]{2,3}[0-9]{7,8}([-|－][0-9]{1,4})?$";
		return startCheck(regex, phone);
	}

	/**
	 * 是否包含空格 Pattern.compile("\\s*|\t|\r|\n"); String str1 = "^*\\s+$"; //String regex = "\\s*"; //String regex =
	 * "\\8+"; //String regex = "\\d+[\\s]+\\d+"; //String regex = "[\\s]*"; //String regex = "(\\s|\\t|\\r)+"; //String
	 * regex = "^[^\\s]*$*";
	 * 
	 * @param phone
	 * @return
	 */
	public static boolean notHasBlank(String phone) {
		String regex = "^[^\\s]*$";
		return startCheck(regex, phone);
	}

	/**
	 * @Description: 删除字符串中的空格，包括字符串中间的 aaa bbbcc ccd = aaabbbccccd
	 * @author wsd
	 * @date
	 * @param str
	 * @return
	...
	public static void main(String[] args) {
		...
		// //System.out.println(UtilRegex.checkEmail("xiyangdewuse@163.com"));

		// //System.out.println(UtilRegex.isMobile("16988127262"));
		// //System.out.println(UtilRegex.notHasBlank("16988127262"));
		// //System.out.println(UtilRegex.notHasBlank("1698 812 7262"));
		// //System.out.println(UtilRegex.notHasBlank("169 8812	7262"));
		// //System.out.println(UtilRegex.notHasBlank("169 88 1272 62"));
		// //System.out.println(UtilRegex.notHasBlank(" "));
		// //System.out.println(UtilRegex.notHasBlank("d大家看 看 "));
		// //System.out.println(UtilRegex.notHasBlank("d大家 看看"));
		// //System.out.println(UtilRegex.notHasBlank("d大家看看"));
		// //System.out.println(getStringNoBlank("  169 88 1272 62"));
		// //System.out.println(getStringNoBlank("aaadfdsfds"));
		// //System.out.println(getStringNoBlank(" 2aaadfdsfds2 "));
	}
