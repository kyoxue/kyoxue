...
public class MathUtil {
	public static void main(String[] args) {
		/*
		 * String
		 * a="1234567891234567891234788778875555555.5678912345678912123456789";
		 * String b="5.787555"; //System.out.println("**** add= "
		 * +Math.add(a,b)); //System.out.println("**** sub= "+Math.sub(a,b));
		 * //System.out.println("**** mul= "+Math.round(Math.mul(a,b),4));
		 * //System.out.println("**** div= "+Math.div(a,b));
		 */
		// System.out.println("*** div="+Math.roundTo5("20", -1));
	}
	...
	// 2009-11-13 收取儿童燃油费 备份
	public static String roundTo5_type(String v, int scale) {
		/*
		 * if (scale < 0) { throw new IllegalArgumentException(
		 * "The scale must be a positive integer or zero"); }
		 */
