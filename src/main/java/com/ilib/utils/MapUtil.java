...
public class MapUtil extends org.apache.commons.collections.MapUtils {
     ...
     * @throws InvocationTargetException
     */
	public static <T, V> T toObject(Class<T> clazz, Map<String, V> map,String dataFormat) throws InstantiationException, IllegalAccessException, InvocationTargetException{
		T object = clazz.newInstance();
		DateTimeConverter dtConverter = new DateConverter();
		dtConverter.setPattern(dataFormat==null||dataFormat.trim().equals("")?"yyyy-MM-dd":dataFormat.trim());
