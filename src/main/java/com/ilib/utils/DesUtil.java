...
public class DesUtil {
	...
	public static String getEncodeByInfo2(String infoStr, String keyStr) throws UnsupportedEncodingException {
		byte[] iv = { (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
				(byte) 0x00 };
		byte[] bodyData = CBCEncrypt(infoStr.getBytes("UTF-8"), keyStr.getBytes("UTF-8"), iv);
		BASE64Encoder base64en = new BASE64Encoder();
	...
	public static void main(String[] args) throws IOException {
		String infoStr = "12313131231";

		String keyStr = "111111111111111111111111111";
